...
interface ShopIconWithNumberSVG extends HTMLAttributes<HTMLDivElement> {
  num: number;
}

const ShopIconWithNumberSVG = ({ num, ...props }: ShopIconWithNumberSVG) => {
  return (
    <div style={{cursor: 'pointer'}} {...props}>
      ...
      >
        ...
        <text x="22.5" y="25.5" textAnchor="middle" fontSize="10" fontWeight="bold" fill="black">
          {num}
        </text>
      </svg>
    </div>
