...
export const ProductListPage = () => {
	const { errorMessage, handleErrorMessage, isToastVisible } =
	...
	const { handleAddCartItems, handleRemoveCartItems, handleUpdateCartItems } =
		useCartItems({
	...
	return (
		...
		>
			{errorMessage && (
				<ErrorToast message={errorMessage} visible={isToastVisible} />
			)}
