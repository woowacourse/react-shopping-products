...
describe('getMergedData', () => {
  const products: Product[] = [
    { id: 1, name: '상품 1', price: 10000, imageUrl: '', category: '식료품' },
    { id: 2, name: '상품 2', price: 20000, imageUrl: '', category: '패션잡화' },
    { id: 3, name: '상품 3', price: 30000, imageUrl: '', category: '식료품' },
  ];
  it('상품 목록과 장바구니 목록을 병합해 새로운 데이터를 만들어 낸다. 이 때, 장바구니에 없는 경우 -1이 추가된다.', () => {
    const cartProducts: CartProduct[] = [
      {
        id: 101,
        product: { id: 1, name: '상품 1', price: 10000, imageUrl: '', category: '식료품' },
        quantity: 2,
      },
      {
        id: 103,
        product: { id: 3, name: '상품 3', price: 30000, imageUrl: '', category: '식료품' },
        quantity: 1,
      },
    ];
